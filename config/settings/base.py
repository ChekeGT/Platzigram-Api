...
)  # (platzigram_api/config/settings/base.py - 3 = platzigram_api/)
APPS_DIR = ROOT_DIR.path("platzigram_api")
...
ADMINS = [("""Francisco Ezequiel Banos Ramirez""", "chekelosos@gmail.com")]
